 ...
 * Generated for Laravel 5.4.1 on 2017-07-03.
 *
...
namespace Bootstrapper\Facades { 
    ...
    class Form {
        ...
        {
            return \Bootstrapper\Form::select($name, $list, $selected, $selectAttributes, $optionsAttributes);
        }
        ...
        {
            //Method inherited from \Collective\Html\FormBuilder            
            return \Bootstrapper\Form::getSelectOption($display, $value, $selected, $attributes);
        }
